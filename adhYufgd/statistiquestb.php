...
<div id="main">
    <div id="contenu">
      ...
      <div id="org_stats" class="tableaudebord">
		  ...
		  // Récupération des données
           ...
           <table id="Tstats2" class="tablesorter stats" summary="Statistique des abonnements et désabonnements">
            ...
            <tr>
            	<th scope="row">Variation moyenne abonnés période</th>
      ...
      <div id="menu">
        <ul>
            <li><a href="tableaudebord.php" title="Retour au tableau de bord"><img src="medias/icones/retour.png" height="64" alt="Retour aux outils de maintenance" /></a></li>
        </ul>
    <form name="formulaire" method="POST" action="statistiquestb.php" enctype="multipart/form-data" class="formulaire small" id="formulaire">
